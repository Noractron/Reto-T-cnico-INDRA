...
describe("POST /api/v1/personajes", () => {
  it("responder con 200 creado", (done) => {
    const data = {
      swappi_id: 8
    };
    request(app)
  ...
  it("responder con 404 bad request", (done) => {
    const data = {
      // no swappi_id
    };
    request(app)
...
describe("PUT /api/v1/personajes/:id", () => {
  it("respuesta con 200 modificado", (done) => {
    const data = {
      swappi_id: 8
    };
    request(app)
  ...
  it("respuesta con 404 bad request", (done) => {
    const data = {
      // no swappi_id
    };
    request(app)
...
describe("POST /api/v1/entrenador", () => {
  it("responde con 200 creado", (done) => {
    const data = {
      nombre: "cecilia",
      apellido: "carreño",
      edad: 26,
  ...
  it("responde con 404 sobre un bad request", (done) => {
    const data = {
      // no swappi_id
    };
    request(app)
...
describe("PUT /api/v1/entrenador/:id", () => {
  it("responde con 200 modificado", (done) => {
    const data = {
      nombre: "cecilia",
      apellido: "carreño",
      edad: 26,
...
describe("POST /api/v1/zona-ejercicio", () => {
  ...
  it("responde con 404 cuando hay un bad request", (done) => {
    const data = {
      // no swappi_id
    };
    request(app)
...
describe("PUT /api/v1/zona-ejercicio/:id", () => {
  it("respode con un 200 modificado", (done) => {
    const data = {
      planeta_id: 12,
      personaje_id: 21,
      entrenador_id: "1"
